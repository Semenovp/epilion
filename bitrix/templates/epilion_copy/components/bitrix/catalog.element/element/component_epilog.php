...
Asset::getInstance()->addCss(SITE_TEMPLATE_PATH."/components/bitrix/catalog.element/element/custom.css", true);
Asset::getInstance()->addJs(SITE_TEMPLATE_PATH."/components/bitrix/catalog.element/element/custom.js");
