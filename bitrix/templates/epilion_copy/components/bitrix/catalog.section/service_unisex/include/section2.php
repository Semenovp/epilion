								  ...
								  <div class="b-removal">
									...
									<dl class="b-removal-dl-inf">
									  ...
									  <dd class="b-removal-dl-inf__dd">Цена</dd>
										...
										<?								
										$arSelect = Array("ID", "NAME", "DETAIL_PAGE_URL","PROPERTY_PRICE1","PROPERTY_PRICE2", "PROPERTY_TITLE_SERVICE",'PROPERTY_HELP','PROPERTY_GENDER');
										...
										while($ob = $res->GetNextElement())
										{
										 $arFields = $ob->GetFields();
										?>
									<dl class="b-removal-dl" data-pic="z_w_<?= $arFields['ID'] ?>" data-id="<?= $arFields['ID'] ?>" data-gender="<?= $arFields['PROPERTY_GENDER_VALUE'] ?>" data-pareny="<?= $ar_fields['NAME'] ?>" data-price="<?= $arFields['PROPERTY_PRICE1_VALUE'] ?>" data-sale="<?= $arFields['PROPERTY_PRICE2_VALUE'] ?>" data-name="<?= $arFields['PROPERTY_TITLE_SERVICE_VALUE'] ?>">
									  <dt class="b-removal-dl__dt">
										...
										<?if ($arFields[ 'PROPERTY_PRICE2_VALUE'] == 0):?>
										<dd class="b-removal-dl__dd"><span class="b-removal-dl__price"><?= $arFields[ 'PROPERTY_PRICE1_VALUE'] ?></span></dd>
										<?else:?>
										<dd class="b-removal-dl__dd"><span class="b-removal-dl__price"><?= $arFields[ 'PROPERTY_PRICE2_VALUE'] ?></span></dd>
										<?endif?>
								   </dl>
										<?
										}
