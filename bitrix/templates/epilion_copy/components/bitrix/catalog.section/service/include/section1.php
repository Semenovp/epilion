                        ...
                        <div class="b-removal">
                          <dl class="b-removal-dl-inf">
                            ...
                            <?
                                ...
                                $arSelect = Array("ID", "NAME", "DETAIL_PAGE_URL","PROPERTY_PRICE1", "PROPERTY_PRICE2", "PROPERTY_TITLE_SERVICE",'PROPERTY_HELP',"PROPERTY_NEW_PRICE","PROPERTY_NEW_PRICE_CARD","PROPERTY_NEW_PRICE_DATE");
                                ...
                                ?>
                            <dl class="b-removal-dl" data-pic="z_w_<?= $arFields['ID'] ?>" data-id="<?= $arFields['ID'] ?>" data-pareny="<?= $arResult['ID']['NAME'] ?>" data-price="<?= $arPrice ?>" data-sale="<?= $arSalePrice ?>" data-name="<?= $arFields['PROPERTY_TITLE_SERVICE_VALUE'] ?>">
                              ...
                              <dd class="b-removal-dl__dd"><span class="b-removal-dl__price"><?= $arPrice ?>
