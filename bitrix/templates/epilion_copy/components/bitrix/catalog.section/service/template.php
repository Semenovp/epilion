					 ...
					 <div class="b-device-item">
					  ...
					  <div class="b-device-item__pic-container">
                          ...
                          <div class="b-device-item__pic">
                              <!--Если задана детальная картинка (для мобилки) - в разрешениях ниже 1250 ее показываем, если нет - общую картинку-->
                              <img srcset="<?= CFile::GetPath($arFields['PREVIEW_PICTURE']);?> 1920w,
                                    <?=(!empty($arFields['DETAIL_PICTURE']))?CFile::GetPath($arFields['DETAIL_PICTURE']):CFile::GetPath($arFields['PREVIEW_PICTURE'])?> 1250w"
                                   src="<?= CFile::GetPath($arFields['PREVIEW_PICTURE']);?>" alt="">
                          </div>
						  <?endif;?>
					  ...
					  <div class="b-device-item__pic-container"><a class="b-device-item__pic b-about-service-video fancybox" href="<?=$arProps['YOUTUBE']['VALUE'];?>" data-fancybox-group="">
                              <!--Если задана детальная картинка (для мобилки) - в разрешениях ниже 1250 ее показываем, если нет - общую картинку-->
                              <img srcset="<?= CFile::GetPath($arFields['PREVIEW_PICTURE']);?> 1920w,
                                    <?=(!empty($arFields['DETAIL_PICTURE']))?CFile::GetPath($arFields['DETAIL_PICTURE']):CFile::GetPath($arFields['PREVIEW_PICTURE'])?> 1250w"
                                    src="<?= CFile::GetPath($arFields['PREVIEW_PICTURE']);?>" alt="">
