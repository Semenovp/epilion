...
<?foreach ($arResult['ITEMS'] as $key=>$Item):?>
    <div class="b-select-procedure-item"><a class="b-select-procedure-item__pic" href="#"><img src="<?= SITE_TEMPLATE_PATH ?>/img/laser-zone-page/select-zone/1.jpg" alt=""></a><a class="b-select-procedure-item__title" href="#">Поверхность бёдер на выбор</a>
              <div class="b-select-procedure-item__price">от 2 000 ₽</div>
            </div>
<?endforeach;?>
