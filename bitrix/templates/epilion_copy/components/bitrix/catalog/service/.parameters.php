...
$ext = 'jpg,jpeg,gif,png';
$arTemplateParameters['AVATAR']=Array(
   "PARENT" => "BASE_SETTINGS",
   "NAME" => 'Фото для аватара к тексту о сервисе',
   "TYPE" => "FILE",
   "FD_TARGET" => "F",
   "FD_EXT" => $ext,
   "FD_UPLOAD" => true,
...
$arTemplateParameters['SLOVO_ABOUT_SERVICE']=Array(
   "PARENT" => "BASE_SETTINGS",
   "NAME" => 'Слово о сервисе',
   "TYPE" => "STRING"
);
$arTemplateParameters['SLOVO_ABOUT_SERVICE_NAME']=Array(
   "PARENT" => "BASE_SETTINGS",
   "NAME" => 'Имя человека который рассказывает о сервисе',
   "TYPE" => "STRING"
);
$arTemplateParameters['SLOVO_ABOUT_SERVICE_DOLZHNOST']=Array(
   "PARENT" => "BASE_SETTINGS",
   "NAME" => 'Должность',
   "TYPE" => "STRING"
);
...
$ext = 'jpg,jpeg,gif,png';
$arTemplateParameters['PHTOHO_FOR_VIDEO']=Array(
   "PARENT" => "BASE_SETTINGS",
   "NAME" => 'Фото для анонса видео',
   "TYPE" => "FILE",
   "FD_TARGET" => "F",
   "FD_EXT" => $ext,
   "FD_UPLOAD" => true,
...
$arTemplateParameters['TEXT_PREVIEW']=Array(
   "PARENT" => "BASE_SETTINGS",
   "NAME" => 'Текст анонса на банере',
   "TYPE" => "STRING"
);
$arTemplateParameters['H1_PREVIEW']=Array(
   "PARENT" => "BASE_SETTINGS",
   "NAME" => 'Заголовок анонса на банере',
   "TYPE" => "STRING"
);
$arTemplateParameters['ABOUT_SERVICE_VIDEO_LINK']=Array(
   "PARENT" => "BASE_SETTINGS",
   "NAME" => 'Ссылка на видео',
   "TYPE" => "STRING"
);
$arTemplateParameters['TEXT_FOR_SERVICE']=Array(
   "PARENT" => "BASE_SETTINGS",
   "NAME" => 'Текст описания под видео о сервисах',
   "TYPE" => "STRING"
);

$arTemplateParameters['LINK_BUTTONS_TEXT1']=Array(
   "PARENT" => "BASE_SETTINGS",
   "NAME" => 'ТЕКСТ КНОПКИ 1',
...
$arTemplateParameters['LINK_BUTTONS_TEXT2']=Array(
   "PARENT" => "BASE_SETTINGS",
   "NAME" => 'ТЕКСТ КНОПКИ 2',
   "DEFAULT" => "О Клинике",
   "TYPE" => "STRING"
);
$arTemplateParameters['LINK_BUTTONS_URL1']=Array(
   "PARENT" => "BASE_SETTINGS",
   "NAME" => 'Ссылка КНОПКИ 2',
   "DEFAULT" => "#",
   "TYPE" => "STRING"
);
$arTemplateParameters['LINK_BUTTONS_URL2']=Array(
   "PARENT" => "BASE_SETTINGS",
   "NAME" => 'Ссылка КНОПКИ 2',
   "DEFAULT" => "#",
   "TYPE" => "STRING"
